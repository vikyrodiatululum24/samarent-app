...
class BastkForm
{
                ...
                Step::make('Informasi BASTK')
                    ...
                    ->schema([
                        Grid::make(2)->schema([
                            ...
                            Forms\Components\CheckboxList::make('kondisi_unit')->label('Kondisi Unit')->options([
                                'new lease' => 'New Lease',
                                'new car' => 'New Car',
                                'used car' => 'Used Car',
    ...
    {
        return [
            ['kelengkapan' => 'Automatic Light Switch'],
            ['kelengkapan' => 'Lampu Kecil'],
            ['kelengkapan' => 'Lampu Dekat'],
            ['kelengkapan' => 'Lampu Jauh'],
            ['kelengkapan' => 'Lampu Dekat/Fog Lamp'],
            ['kelengkapan' => 'Lampu Sein Depan'],
            ['kelengkapan' => 'Lampu Sein Belakang'],
            ['kelengkapan' => 'Lampu Belakang'],
            ['kelengkapan' => 'Lampu Rem'],
            ['kelengkapan' => 'Lampu Mundur'],
            ['kelengkapan' => 'Lampu Dashboard'],
            ['kelengkapan' => 'Lampu Plafon Depan & Belakang'],
            ['kelengkapan' => 'Klakson'],
            ['kelengkapan' => 'Antena'],
            ['kelengkapan' => 'Tape/Radio/CD/DVD/TV Player'],
            ['kelengkapan' => 'Remote Tape/Radio/CD/DVD/TV Player'],
            ['kelengkapan' => 'Alarm + Remote + Key'],
            ['kelengkapan' => 'Central Lock'],
            ['kelengkapan' => 'Power Window'],
            ['kelengkapan' => 'Switch Mirror'],
            ['kelengkapan' => 'Air Conditioner'],
            ['kelengkapan' => 'Safety Belt'],
            ['kelengkapan' => 'Karpet'],
            ['kelengkapan' => 'Lighter'],
            ['kelengkapan' => 'Asbak'],
            ['kelengkapan' => 'Sarung Jok'],
            ['kelengkapan' => 'Sandaran Kepala'],
            ['kelengkapan' => 'Spion Dalam'],
            ['kelengkapan' => 'Wiper Blade'],
            ['kelengkapan' => 'Windshield Washer'],
            ['kelengkapan' => 'Talang Air'],
            ['kelengkapan' => 'Fender Lumpur Depan & Belakang'],
            ['kelengkapan' => 'Spoiler Kiri / Kanan'],
            ['kelengkapan' => 'Tutup Bensin'],
            ['kelengkapan' => 'Emblem / Logo'],
            ['kelengkapan' => 'Kaca Mobil / Kaca Film'],
            ['kelengkapan' => 'STNK'],
            ['kelengkapan' => 'Buku KJR / Stiker / Peneng'],
            ['kelengkapan' => 'Owner Manual Book'],
            ['kelengkapan' => 'Buku Service'],
            ['kelengkapan' => 'Ban Serep'],
            ['kelengkapan' => 'Kunci Roda/Busi/Pas/Tang'],
            ['kelengkapan' => 'Kunci Stir'],
            ['kelengkapan' => 'Dongkrak'],
            ['kelengkapan' => 'P3K'],
            ['kelengkapan' => 'Segitiga Pengaman'],
            ['kelengkapan' => 'Lap Kanebo'],
            ['kelengkapan' => 'Velg Ban'],
            ['kelengkapan' => 'Tutup Dop'],
            ['kelengkapan' => 'Apar'],
            ['kelengkapan' => 'BBM & KM'],
        ];
    }
