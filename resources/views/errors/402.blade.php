...
<body>
    <main class="center">
        <div class="card" role="alert" aria-labelledby="err-code err-title">
            <h1 id="err-code">402</h1>
            <h2 id="err-title">Pembayaran Diperlukan</h2>
            <p>Halaman ini memerlukan pembayaran untuk diakses. Silakan hubungi administrator untuk informasi lebih lanjut.</p>
