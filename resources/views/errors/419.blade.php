...
<body>
    <main class="center">
        <div class="card" role="alert" aria-labelledby="err-code err-title">
            <h1 id="err-code">419</h1>
            <h2 id="err-title">Halaman Kedaluwarsa</h2>
            <p>Sesi Anda telah kedaluwarsa karena tidak ada aktivitas. Silakan refresh halaman dan coba lagi.</p>

            <div class="actions">
                <a href="{{ url()->current() }}" class="btn">Refresh Halaman</a>
