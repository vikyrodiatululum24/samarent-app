...
<body>
    <main class="center">
        <div class="card" role="alert" aria-labelledby="err-code err-title">
            <h1 id="err-code">429</h1>
            <h2 id="err-title">Terlalu Banyak Permintaan</h2>
            <p>Anda telah mengirim terlalu banyak permintaan dalam waktu singkat. Silakan tunggu beberapa saat dan coba lagi.</p>
