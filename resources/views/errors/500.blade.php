...
<head>
    ...
    <style>
        :root { --bg:#f7f9fc; --card:#ffffff; --muted:#6b7280; --accent:#ef4444; }
        ...
        .btn { display:inline-block; padding:.6rem 1rem; border-radius:8px; text-decoration:none; color:#fff; background:var(--accent); font-weight:600; box-shadow:0 6px 16px rgba(239,68,68,0.18); }
...
<body>
    <main class="center">
        <div class="card" role="alert" aria-labelledby="err-code err-title">
            <h1 id="err-code">500</h1>
            <h2 id="err-title">Kesalahan Server</h2>
            <p>Maaf, terjadi kesalahan pada server kami. Tim kami telah diberitahu dan sedang menangani masalah ini.</p>
