...
<head>
    ...
    <style>
        :root { --bg:#f7f9fc; --card:#ffffff; --muted:#6b7280; --accent:#f59e0b; }
        ...
        .btn { display:inline-block; padding:.6rem 1rem; border-radius:8px; text-decoration:none; color:#fff; background:var(--accent); font-weight:600; box-shadow:0 6px 16px rgba(245,158,11,0.18); }
...
<body>
    <main class="center">
        <div class="card" role="alert" aria-labelledby="err-code err-title">
            <h1 id="err-code">503</h1>
            <h2 id="err-title">Layanan Tidak Tersedia</h2>
            <p>Kami sedang melakukan maintenance pada sistem. Layanan akan segera kembali normal. Terima kasih atas kesabaran Anda.</p>

            <div class="actions">
                <a href="{{ url()->current() }}" class="btn">Coba Lagi</a>
