...
<body>
    <main class="center">
        <div class="card" role="alert" aria-labelledby="err-code err-title">
            <h1 id="err-code">401</h1>
            <h2 id="err-title">Akses Ditolak</h2>
            <p>Anda tidak memiliki izin untuk mengakses halaman ini. Jika Anda merasa ini sebuah kesalahan, silakan hubungi administrator.</p>
            ...
            <footer>
                {{-- Opsional: tampilkan info tambahan saat APP_DEBUG aktif --}}
                @if(config('app.debug'))
